...
INSERT INTO `application` VALUES (1,4,'','0000-00-00',' ','','','Post Graduate','a:1:{i:0;a:3:{i:0;s:0:\"\";i:1;s:0:\"\";i:2;s:0:\"\";}}','a:1:{i:0;a:3:{i:0;s:0:\"\";i:1;s:0:\"\";i:2;s:0:\"\";}}','C:/wamp64/www/fashion/images/application/cv/','','',28);
...
CREATE TABLE `client_department` (
  ...
  CONSTRAINT `client_department_ibfk_2` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`)
...
INSERT INTO `client_department` VALUES (1,'1'),(4,'1'),(14,'1'),(5,'2'),(6,'3'),(13,'3'),(7,'4'),(8,'5');
...
INSERT INTO `jobs` VALUES (2,1,'1','New Recruitment','SMM','Social media marketer','2018-06-15','2018-06-20','null'),(4,1,'2','aaa','Jr Exec','aaa','2018-06-05','2018-06-01','C:/xampp/htdocs/fashion/images/job/18557112_1860632280631523_549291065253158337_n.jpg');
...
INSERT INTO `user` VALUES (1,'First Applicant','pw','dwadwa@gmail.com\r\n','user'),(2,'admin1','admin1','admin1@gmail.com','admin'),(3,'admin2','admin2','admin2@gmail.com','admin'),(4,'client1','client1','client1@gmail.com','client'),(5,'client2','client2','client2@gmail.com','client'),(6,'client3','client3','client3@gmail.com','client'),(7,'client4','client4','client4@gmail.,com','client'),(8,'client5','client5','client5','client'),(13,'newuser','newuser','dwada@gm.com','client'),(14,'','','','client');
...
-- Dump completed on 2018-06-09 18:02:36
