...
require($_SERVER['DOCUMENT_ROOT'] . '/fashion/php/dbcon.php');
 ...
 /* Marks */
    ...
    $sql="INSERT INTO application (u_id,c_id,name,dob,address,contactno,email,education,work_experience,prof_q,cv,img,status,mark) VALUES ('$u_id','job_id','$name','$bdate',' $address','$contactno','$email','$edu','$work_data', '$prof_data','$cvpath','$img_data','received',$tot_mark)";
